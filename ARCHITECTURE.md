...
| Contract | Role |
|---|---|
| [`AdminTimelock.sol`](file://~/Zold-app/Zold%20antigravity%20workspace/zold-app/contracts/src/AdminTimelock.sol) | M-of-N multisig with timelock delay owning protocol contracts. Guardian role can pause instantly. |
| [`FxSwapper.sol`](file://~/Zold-app/Zold%20antigravity%20workspace/zold-app/contracts/src/FxSwapper.sol) | On-chain FX swapper with rate configuration and slippage protection. |
| [`BridgeEscrow.sol`](file://~/Zold-app/Zold%20antigravity%20workspace/zold-app/contracts/src/BridgeEscrow.sol) | Escrow locking USDC for cross-chain payouts to Stellar. |
